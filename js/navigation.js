...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.trpcultivate_theme.areAnySubNavsOpen()) {
          props.trpcultivate_theme.closeAllSubNav();
        } else {
      ...
      if (e.key === 'Tab' && isNavOpen(props.navWrapper)) {
        ...
        if (e.shiftKey) {
          if (
            ...
            !props.trpcultivate_theme.isDesktopNav()
          ) {
    ...
    window.addEventListener('resize', () => {
      if (props.trpcultivate_theme.isDesktopNav()) {
        toggleNav(props, false);
      ...
      Drupal.trpcultivate_theme.closeAllSubNav();
    });
   ...
   */
  Drupal.behaviors.trpcultivate_themeNavigation = {
    attach(context) {
      ...
      if (header) {
        ...
        const { trpcultivate_theme } = Drupal;
