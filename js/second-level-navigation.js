...
((Drupal) => {
  const { isDesktopNav } = Drupal.trpcultivate_theme;
  ...
  Drupal.trpcultivate_theme.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.trpcultivate_theme.isDesktopNav()) return;
  ...
  Drupal.trpcultivate_theme.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.trpcultivate_theme.areAnySubNavsOpen = areAnySubNavsOpen;
