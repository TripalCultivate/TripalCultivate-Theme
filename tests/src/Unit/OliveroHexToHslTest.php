...
namespace Drupal\Tests\trpcultivate_theme\Unit;

use Drupal\Tests\UnitTestCase;

/**
 * Tests the _trpcultivate_theme_hex_to_hsl() function.
 *
 * @group trpcultivate_theme
 */
final class TripalCultivateThemeHexToHslTest extends UnitTestCase {
  ...
  public function setUp(): void {
    parent::setUp();
    require_once __DIR__ . '/../../../trpcultivate_theme.theme';
  }
  ...
  public function testHexToHsl(string $hex, array $expected_hsl): void {
    self::assertEquals($expected_hsl, _trpcultivate_theme_hex_to_hsl($hex));
  }
