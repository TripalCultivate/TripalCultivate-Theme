...
namespace Drupal\trpcultivate_theme;

use Drupal\Core\Security\TrustedCallbackInterface;

/**
 * Implements trusted prerender callbacks for the TripalCultivateTheme theme.
 *
 * @internal
 */
class TripalCultivateThemePreRender implements TrustedCallbackInterface {
